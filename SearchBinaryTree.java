public class SearchBinaryTree {
        ...
        public static void main(String[] args) {
            ...
            bt.root.left.left.left.left = new Node(3);
            bt.root.left.left.left.right = new Node(16);
            bt.root.right.left.right = new Node(65);
            bt.root.right.left.right.left = new Node(63);
            bt.root.right.left.right.right = new Node(67);

            //Search for node 5 in the binary tree
            bt.searchNode(bt.root, 63);
